...
pub fn impl_derive_visit(emitter: &mut Emitter, input: &syn::DeriveInput) -> TokenStream2 {
    ...
    let default_visit_sigs: Vec<syn::Signature> = [
        ...
        "fn visit_grant_account_permission(operation: &Mint<PermissionToken, Account>)",
        "fn visit_revoke_account_permission(operation: &Burn<PermissionToken, Account>)",
        "fn visit_register_role(operation: &Register<Role>)",
        "fn visit_unregister_role(operation: &Unregister<Role>)",
        "fn visit_grant_account_role(operation: &Mint<RoleId, Account>)",
        "fn visit_revoke_account_role(operation: &Burn<RoleId, Account>)",
        "fn visit_grant_role_permission(operation: &Mint<PermissionToken, Role>)",
        "fn visit_revoke_role_permission(operation: &Burn<PermissionToken, Role>)",
        "fn visit_register_trigger(operation: &Register<Trigger<TriggeringEventFilterBox>>)",
        "fn visit_unregister_trigger(operation: &Unregister<Trigger<TriggeringEventFilterBox>>)",
        "fn visit_mint_trigger_repetitions(operation: &Mint<u32, Trigger<TriggeringEventFilterBox>>)",
        "fn visit_burn_trigger_repetitions(operation: &Burn<u32, Trigger<TriggeringEventFilterBox>>)",
